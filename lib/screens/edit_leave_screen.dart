...
class _EditLeaveScreenState extends State<EditLeaveScreen> {
  ...
  void initState() {
    ...
    selectedLeaveType = _getLeaveTypeFromString(widget.currentType);
    reasonController = TextEditingController(text: widget.currentReason);
    selectedFileName = widget.currentAttachment.split('/').last;
  }

  LeaveType _getLeaveTypeFromString(String type) {
    switch (type) {
      case 'Personal Leave':
      ...
      case 'Marriage Leave':
        return LeaveType.marriageLeave;
      default:
        return LeaveType.personalLeave;
    }
  }
  ...
  Future<void> updateLeave() async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'https://presensi.amikomcenter.com/api/leaves/${widget.leaveId}'),
      );
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to update leave: ${response.body}');
      }
    } catch (e) {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: isLoading ? null : updateLeave,
